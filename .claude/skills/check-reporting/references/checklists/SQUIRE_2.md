...
| 9 | Study of the intervention(s) | a) Approach chosen for assessing the impact of the intervention(s). b) Approach used to establish whether the observed outcomes were due to the intervention(s). |
